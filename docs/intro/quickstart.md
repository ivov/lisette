...
Each dir in `src/` is a package, imported by name. `main.lis` is the entry point. A project without one is a [library](../reference/12-packages.md#library-projects).
