...
use checks::{
    ...
    check_identical_match_arms, check_ineffective_bit_mask, check_ineffective_omitempty,
    check_infallible_assertion, check_integer_division_to_zero,
    ...
    check_manual_option_zip, check_manual_replace_all, check_manual_rotate,
    ...
    check_match_literal_collection, check_match_on_bool, check_match_same_arms,
    check_match_single_binding, check_misrefactored_assign_op, check_needless_bool_assign,
    check_needless_continue, check_needless_match, check_needless_question_mark,
    check_needless_splitn, check_needless_update, check_neg_multiply, check_negated_equality,
