...
use checks::{
    ...
    check_redundant_slice_bounds, check_redundant_sprintf, check_redundant_trim_guard,
    check_regexp_in_loop, check_replace_count_zero, check_replaceable_with_autofill,
