...
use checks::{
    ...
    check_manual_map, check_manual_map_or, check_manual_min_max, check_manual_ok_err,
    check_manual_ok_or, check_manual_option_zip, check_manual_replace_all, check_manual_rotate,
