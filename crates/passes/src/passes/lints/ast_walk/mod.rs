...
use checks::{
    ...
    check_duplicate_logical_operand, check_empty_match_arm, check_enum_variant_names,
    ...
    check_needless_question_mark, check_needless_splitn, check_needless_update, check_neg_multiply,
    check_negated_equality, check_negated_logical_operand, check_nested_fstring,
    check_non_negative_comparison, check_or_fn_call, check_out_of_domain_value,
    check_pattern_naming, check_printf_verb_mismatch, check_redundant_closure,
    check_redundant_closure_call, check_redundant_comparison, check_redundant_else,
    check_redundant_field_names, check_redundant_fstring_conversion, check_redundant_guards,
    check_redundant_operation, check_redundant_pattern_matching, check_redundant_rebinding,
    check_redundant_slice_bounds, check_redundant_sprintf, check_regexp_in_loop,
    check_replace_count_zero, check_replaceable_with_autofill, check_rest_only_pattern,
    check_self_assignment, check_self_comparison, check_self_named_constructors,
    check_single_arm_select, check_single_element_loop, check_type_limit_comparison,
    check_unconditional_recursion, check_uninterpolated_fstring, check_unnecessary_bool,
