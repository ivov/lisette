//! Literal emission: integers, floats, strings, format strings, slice literals.
//! `convert_escape_sequences` lives here because it's only used by literal
//! emission and pattern-binding literal rendering.
