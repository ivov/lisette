...
use checks::{
    ...
    check_manual_map, check_manual_replace_all, check_manual_time_since, check_manual_time_until,
    check_manual_unwrap_or, check_match_literal_collection, check_match_on_bool,
    check_match_single_binding, check_negated_equality, check_non_negative_comparison,
    ...
    check_redundant_sprintf, check_replaceable_with_zero_fill, check_rest_only_slice_pattern,
    check_self_assignment, check_self_comparison, check_single_arm_match, check_single_arm_select,
