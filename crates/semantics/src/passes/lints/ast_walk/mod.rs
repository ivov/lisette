...
use checks::{
    ...
    check_identical_match_arms, check_invisible_in_string_expression,
    check_invisible_in_string_pattern, check_let_and_return, check_loop_runs_once,
    check_lost_query_mutation, check_manual_compound_assignment, check_manual_is_empty,
    check_manual_map, check_manual_unwrap_or, check_match_literal_collection, check_match_on_bool,
